...
def build_patch_transformer(
    ...
    #Creating Positional embedding for ordering
...
def plot_loss(history, save_path="figures/patch_transformer_loss.png"):
...
def plot_forecast(y_true, y_pred, save_path="figures/patch_transformer_forecast.png"):
    os.makedirs(os.path.dirname(save_path), exist_ok=True)
...
def main():
    ...
    #Loading PJM data using 336-hour input window and 24-hour output window
    ...
    model.save_weights("models/transformer_weights.weights.h5")
