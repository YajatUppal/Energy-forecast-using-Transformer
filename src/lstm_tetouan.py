...
def build_lstm_model(input_shape=(336, 9), output_window=24):
    model = Sequential([
        # 32 hidden units
...
def plot_loss(history, save_path="figures/lstm_tetouan_loss_curve.png"):
...
def plot_forecast(y_true, y_pred, save_path="figures/lstm_tetouan_forecast_example.png"):
    os.makedirs(os.path.dirname(save_path), exist_ok=True)
...
def main():
    ...
    model.save("models/lstm_tetouan_model.h5")
